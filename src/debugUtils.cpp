...
std::string throwMsgOnRowsOnPSxDim(const char* matName, const Eigen::MatrixXd& mat, const System* ps)
{
    std::ostringstream os;
...
std::string throwMsgOnRowsOnPSUDim(const char* matName, const Eigen::MatrixXd& mat, const System* ps)
{
    std::ostringstream os;
...
std::string throwMsgOnColsOnPSXDim(const char* matName, const Eigen::MatrixXd& mat, const System* ps)
{
    std::ostringstream os;
    os << matName << " should have " << std::to_string(ps->xDim) << " or " << std::to_string(ps->fullXDim)
...
std::string throwMsgOnColsOnPSUDim(const char* matName, const Eigen::MatrixXd& mat, const System* ps)
{
    std::ostringstream os;
    os << matName << " should have " << std::to_string(ps->uDim) << " or " << std::to_string(ps->fullUDim)
       << " cols. But " << matName << " has " << std::to_string(mat.cols()) << " cols.";
...
std::string throwMsgOnColsOnPSxuDim(const char* mat1Name, const char* mat2Name, const Eigen::MatrixXd& mat1, const Eigen::MatrixXd& mat2, const System* ps)
{
    std::ostringstream os;
